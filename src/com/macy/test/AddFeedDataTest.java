...
public class AddFeedDataTest {

	public static final Logger logger = Logger.getLogger(AddFeedDataTest.class);
	private static WebDriver driver;
	Login login = new Login();
	FeedData feedBO = new FeedData();
	LoadProperty prop = new LoadProperty();

	public AddFeedDataTest() {
		// TODO Auto-generated constructor stub
		logger.info("Constructor of AddFeedDataTest");
